...
>>>>>>>> 2e1e796 (Fix : 마우스 호버 기능을 뺌):src/components/Map/GoogleMap.tsx
const defaultCenter = {
  lat: 37.566826,
  lng: 126.9786567,
};
...
<<<<<<<< HEAD:src/data/mapData.ts
export { defaultCenter, OUTER_BOUNDS, bounds, options, COORDINATES_STRING };
========
// 서울 지역의 좌표를 파싱하고 순서를 반전
const seoulCoordinates = parseCoordinates(COORDINATES_STRING);

>>>>>>> 2e1e796 (Fix : 마우스 호버 기능을 뺌)
const Map = () => {
